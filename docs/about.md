...
approximate, are left exactly as they are, and are only replaced by a complete re-import — never
silently overwritten or presented as corrected. All of it stays on your device.
