...
- [ ] **Step 2: Write UniversalCardDisplayMode enum**
```kotlin
...
- [ ] **Step 3: Delete old DashboardMetricPresentation**
...
- [ ] **Step 1: Write UniversalMetricCardSpec**
```kotlin
package app.readylytics.health.core.ui.components.metriccard
...
- [ ] **Step 1: Move components and rename**
...
- [ ] **Step 2: Refactor UniversalMetricCard signature**
...
- [ ] **Step 1: Update Presentation Factory**
...
- [ ] **Step 2: Update Dashboard Screen Rendering**
...
- [ ] **Step 1: Replace M3ScoreGaugeCard with UniversalMetricCard**
...
- [ ] **Step 2: Replace MetricCard & CircadianConsistencyCard**
...
- [ ] **Step 1: Replace old cards in Vitals**
