...
@Singleton
class CardConfigurationRepositoryImpl
    @Inject
    constructor(
        ...
        override fun dashboardCardConfigurations(): Flow<List<CardConfiguration>> =
            dataStore.data
                .catch { exception ->
        ...
        override suspend fun updateDashboardCardConfigurations(cards: List<CardConfiguration>) {
