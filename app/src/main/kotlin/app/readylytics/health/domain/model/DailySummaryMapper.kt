...
object DailySummaryMapper {
    fun toDomain(entity: DailySummaryEntity): DailySummary {
        ...
        return DailySummary(
            ...
            paiWorkoutOnly = entity.paiWorkoutOnly,
            paiEverydayHr = entity.paiEverydayHr,
            totalPaiWorkoutOnly = entity.totalPaiWorkoutOnly,
            totalPaiEverydayHr = entity.totalPaiEverydayHr,
    ...
    fun toEntity(domain: DailySummary): DailySummaryEntity {
        ...
        return DailySummaryEntity(
            ...
            paiWorkoutOnly = domain.paiWorkoutOnly,
            paiEverydayHr = domain.paiEverydayHr,
            totalPaiWorkoutOnly = domain.totalPaiWorkoutOnly,
            totalPaiEverydayHr = domain.totalPaiEverydayHr,
