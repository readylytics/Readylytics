...
object AccessibilityLabels {
    ...
    fun trendChart(chartName: String, direction: String?): String =
        if (direction != null) {
...
object AccessibilityStatus {
    fun metricStatus(title: String, status: String): String =
        "$title status: $status"

    fun alertMessage(severity: String, message: String): String =
        "$severity alert: $message"

    fun guidanceMessage(tip: String): String =
        "Tip: $tip"
}
