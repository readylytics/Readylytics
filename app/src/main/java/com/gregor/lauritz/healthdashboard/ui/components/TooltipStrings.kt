...
const val SLEEP_SCORE_TOOLTIP = "Total quality of rest based on duration and cycles.\n\n" +
    "• 80–100: Optimal\n" +
    "• 60–79: Fair\n" +
    "• < 60: Poor"

const val PAI_TOOLTIP = "Your 7-day rolling heart health score.\n" +
...
fun circadianTooltipText(thresholdMinutes: Int) = buildString {
