...
import com.gregor.lauritz.healthdashboard.widgets.workers.WidgetUpdateWorker
import dagger.Lazy
...
class WorkerScheduler
    ...
    constructor(
        ...
        companion object {
            ...
            const val WIDGET_UPDATE_WORK_NAME = "widget_update_periodic"
        }
        ...
        suspend fun scheduleWidgetUpdateWorker() =
            withContext(Dispatchers.IO) {
                val constraints =
                    Constraints
                        .Builder()
                ...
                val request =
                    PeriodicWorkRequestBuilder<WidgetUpdateWorker>(1, TimeUnit.DAYS)
                        .setConstraints(constraints)
                        .setBackoffCriteria(BackoffPolicy.EXPONENTIAL, 1, TimeUnit.HOURS)
                        .build()
