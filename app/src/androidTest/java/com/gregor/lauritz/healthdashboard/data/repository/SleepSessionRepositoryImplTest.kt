...
class SleepSessionRepositoryImplTest {
    ...
    @Test
    fun getSince_emptyDatabase_returnsEmptyList() = runTest {
    ...
    @Test
    fun countSince_emptyDatabase_returnsZero() = runTest {
    ...
    @Test
    fun getSince_singleSession_returnsThatSession() = runTest {
    ...
    @Test
    fun getSince_multipleSessionsAfterCutoff_returnsAll() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
    ...
    @Test
    fun getSince_sessionBeforeCutoff_excluded() = runTest {
        dao.upsertAll(
            listOf(
                session("old",    t1Start),
    ...
    @Test
    fun getLatest_returnsNewestSession() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
    ...
    @Test
    fun getPaged_firstPage_returnsLimitedResults() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
    ...
    @Test
    fun getPaged_secondPage_returnsRemainder() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
    ...
    @Test
    fun upsertAll_updatesExistingSession() = runTest {
    ...
    @Test
    fun upsertAll_batchInsert_allSessionsPersisted() = runTest {
    ...
    @Test
    fun deleteById_removesOnlyTargetSession() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
    ...
    @Test
    fun deleteBeforeTimestamp_removesOldSessions() = runTest {
        dao.upsertAll(
            listOf(
                session("old",    t1Start),
                session("recent", t3Start),
    ...
    @Test
    fun observeSince_emitsCurrentState() = runTest {
        dao.upsertAll(listOf(session("s1", t1Start)))
    ...
    @Test
    fun observeLatest_emitsLatestSession() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
    ...
    @Test
    fun deleteSession_cascadesStages() = runTest {
        dao.upsertAll(listOf(session("s1", t1Start)))
        stageDao.upsertAll(
            listOf(
    ...
    @Test
    fun countSince_correctCountAfterInsert() = runTest {
        dao.upsertAll(
            listOf(
                session("s1", t1Start),
                session("s2", t2Start),
