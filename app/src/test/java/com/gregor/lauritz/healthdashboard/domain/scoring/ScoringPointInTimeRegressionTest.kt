...
class ScoringPointInTimeRegressionTest {
    ...
    @Test
    fun verifyHistoricalRecomputationIsStableAfterPreferencesChange() = runTest {
        ...
        val frozenSnapshot = DailySummaryEntity(
        ...
        coEvery { heartRateDao.getByTimeRange(any(), any()) } returns emptyList() // triggers fallback using workout.trimp
        ...
        val mutatedPrefs = UserPreferences(
