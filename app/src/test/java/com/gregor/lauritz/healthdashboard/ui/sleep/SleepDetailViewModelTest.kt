...
class SleepDetailViewModelTest {
    ...
    @Test
    fun whenSessionIsNull_emitsEmptyState() = testScope.runTest {
    ...
    @Test
    fun whenSessionExists_emitsStateWithStages() = testScope.runTest {
    ...
    @Test
    fun whenTotalMinutesIsZero_percentagesAreZero() = testScope.runTest {
