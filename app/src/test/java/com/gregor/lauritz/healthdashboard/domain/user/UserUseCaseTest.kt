...
class UserUseCaseTest {
    private val settingsRepo =
        mockk<
            com.gregor.lauritz.healthdashboard.data.preferences.SettingsRepository,
        >(relaxed = true)
    private val healthSyncUseCase =
        mockk<
            com.gregor.lauritz.healthdashboard.domain.sync.HealthSyncUseCase,
        >(relaxed = true)
    private val scoringRepository =
        mockk<
            com.gregor.lauritz.healthdashboard.domain.repository.ScoringRepository,
        >(relaxed = true)
