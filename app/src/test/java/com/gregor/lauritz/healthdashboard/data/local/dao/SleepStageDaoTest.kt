...
class SleepStageDaoTest {
    ...
    fun setup() {
        ...
        // Create test session
        val testSession = SleepSessionEntity(
            id = "session1",
            startTime = 0,
            endTime = 6_000_000,
            durationMinutes = 100,
    ...
    @Test
    fun upsertAll_insertsAllStages() = runTest {
        // Given: 3 stages
        val stages = listOf(
            SleepStageEntity(
                sessionId = "session1",
    ...
    @Test
    fun observeStagesForSession_returnsOrderedByStartTime() = runTest {
    ...
    @Test
    fun deleteForSession_removesAllStagesForSession() = runTest {
        // Given: stages for 2 sessions
        val session1Stages = listOf(
            SleepStageEntity(
                sessionId = "session1",
                stageType = "DEEP",
                startTime = 0,
    ...
    @Test
    fun deleteForSession_returnsDeletedCount() = runTest {
    ...
    @Test
    fun uniqueConstraint_preventsIdenticalStages() = runTest {
        // Given: stage with (sessionId="session1", startTime=0)
        val stage1 = SleepStageEntity(
            sessionId = "session1",
            stageType = "DEEP",
            startTime = 0,
            endTime = 1_800_000,
    ...
    @Test
    fun cascadeDelete_removesStagesWhenSessionDeleted() = runTest {
