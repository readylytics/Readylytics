...
class RollingWindowTest {
    ...
    @Test
    fun `getWorkoutsInRange filters correctly`() =
        runTest {
        ...
        runTest {
            ...
            workoutDao.upsertAll(
                listOf(
                    ...
                    WorkoutRecordEntity(
                        id = "3",
                        startTime = yesterdayMs + 1000,
                        endTime = yesterdayMs + 2000,
                        exerciseType = "Running",
                        durationMinutes = 10,
                        trimp = 20f,
                        zone1Minutes = 0f,
