...
class SettingsReopenAfterSetupFlowTest {
    ...
    private class LocalSettingsSetupHarness {
        ...
        private val reader = object : UserPreferencesReader {
            override val userPreferences: StateFlow<UserPreferences> = preferences
        }

        private val physiologySettings = object : PhysiologySettings {
        ...
        private val displaySettings = object : DisplaySettings {
        ...
        private val userProfileActions = object : UserProfileActions {
        ...
        private val healthDataRefresh = object : HealthDataRefresh {
