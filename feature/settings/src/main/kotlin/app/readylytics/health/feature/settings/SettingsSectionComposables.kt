...
@Composable
private fun ActivityThresholdsSubsection(
    stepGoal: Int,
    onUIEvent: (SettingsEvent) -> Unit,
) {
...
@Composable
private fun SleepThresholdsSubsection(
    sleepState: SleepSettingsState,
    onSleepEvent: (SettingsEvent) -> Unit,
    isResyncing: Boolean,
) {
...
@Composable
private fun HeartRateProfileSubsection(
    heartRateState: HeartRateZonesState,
    physiologyState: PhysiologySettingsState,
...
@Composable
private fun LoadSourcesTolerance(
    sleepState: SleepSettingsState,
    onSleepEvent: (SettingsEvent) -> Unit,
    isResyncing: Boolean,
) {
...
@Composable
private fun CircadianThresholdsSubsection(
    thresholdState: ThresholdSettingsState,
    physiologyState: PhysiologySettingsState,
    onThresholdEvent: (SettingsEvent) -> Unit,
    controlsEnabled: Boolean,
