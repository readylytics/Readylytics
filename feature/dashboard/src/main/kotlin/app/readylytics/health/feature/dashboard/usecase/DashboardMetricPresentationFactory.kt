...
import app.readylytics.health.core.model.domain.model.bodyTemperatureStatus
import app.readylytics.health.core.model.domain.model.circadianConsistencyStatus
import app.readylytics.health.core.model.domain.model.normalizedSleepEfficiencyPercent
import app.readylytics.health.core.model.domain.model.scoreStatus
import app.readylytics.health.core.model.domain.model.sleepEfficiencyStatus
    ...
    constructor(
        ...
        fun build(
            ...
            map[CardId.RESIDUAL_FATIGUE] =
                residualFatiguePresentationFactory.build(
                    summary = summary,
                    preferences = preferences,
