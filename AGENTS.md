# Codex Orchestration (OMC)

Operating under oh-my-Codex (OMC) multi-agent layer.
...
- **Trigger via:** `/oh-my-Codex:<skill>`
- **Autopilots:** autopilot, ultrawork, ralph, tdd, deepsearch, ultrathink, deslop. Cancel: `/oh-my-Codex:cancel`
