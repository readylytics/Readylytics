...
object DatabaseMigrations {
    ...
    private val MIGRATION_2_3 =
        object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Recreate daily_summaries to ensure all diagnostic/contributor columns exist.
                // This handles cases where version 2 was partially deployed without these columns.
                db.execSQL("DROP TABLE IF EXISTS `daily_summaries`")
                db.execSQL(
                    """
                    CREATE TABLE IF NOT EXISTS `daily_summaries` (
                ...
                // Ensure insight_dismissals table exists (idempotent)
                db.execSQL(
                    """
