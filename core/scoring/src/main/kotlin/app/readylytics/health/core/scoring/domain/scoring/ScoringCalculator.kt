...
interface ScoringCalculator {
    ...
    fun computeRestorationSubScore(
        ...
        restorationWeights: app.readylytics.health.core.scoring.domain.scoring.components.RestorationWeights? = null,
        frozenLnMu: Float? = null,
        frozenLnSigma: Float? = null,
    ...
    fun computeSleepScore(
        ...
        sleepTargets: app.readylytics.health.core.scoring.domain.scoring.components.SleepArchitectureTargets? = null,
    ...
    fun computeRecoveryFlags(
        ...
        emergencyFlags: app.readylytics.health.core.scoring.domain.scoring.components.EmergencyFlagThresholds? = null,
