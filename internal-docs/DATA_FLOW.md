...
| `core/database/src/main/kotlin/app/readylytics/health/core/database/data/local/HealthDatabase.kt`                                             | Storage — Room DB (v15)                             | 17 entities; pre-bridge Room migration chain ends at v6; external migration owns v7; Room owns v7→v15 |
