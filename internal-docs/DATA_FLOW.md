...
Deletions without stored interval bounds conservatively span `Long.MIN_VALUE..Long.MAX_VALUE`, while known records track their exact bounds in `health_source_records` via `IntervalSourceRecord`.
