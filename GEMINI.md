# Antigravity Orchestration (GEMINI.md)
...
- **Pre-Commit (Mandatory Verification):** `./gradlew ktlintFormat && ./gradlew detekt && ./gradlew assembleDebug && ./gradlew testDebugUnitTest` (and run `./gradlew lintRelease` at the end after resolving all coding tasks)
