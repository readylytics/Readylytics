...
- **Pre-Commit (Mandatory Verification):** `./gradlew ktlintFormat && ./gradlew testDebugUnitTest` (and run `./gradlew lintRelease` at the end after resolving all coding tasks)
